    ...
    <main className={styles.page}>
      ...
      <section className={styles.hero} aria-labelledby="organizers-title">
        ...
        <form action="/organizers" method="get" role="search" className={styles.searchPanel}>
          ...
          <FilterSelect name="region" defaultValue="benin" ariaLabel="Région" options={[{ value: 'benin', label: '🇧🇯 Bénin' }]} style={{ minHeight: 36, borderRadius: 15, background: 'var(--field-bg)', borderColor: 'var(--border)', fontSize: 'var(--font-size-body)', padding: '0 12px' }} />
      ...
      <section className={styles.directory} aria-labelledby="organizer-directory-title">
        ...
        {organizers.length > 0 ? (
          ...
          <div className={styles.empty}><Mascot mood="search" size={250} /><h3>Aucun organisateur trouvé</h3><p>Essayez une autre recherche.</p><Link href="/organizers">Voir tous les organisateurs</Link></div>
        )}
